  ...
  return (
    ...
    >
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 1.25c-.734 0-1.357 0-1.85.07-.515.072-1.016.224-1.463.671-.447.447-.6.948-.67 1.463-.07.493-.07 1.116-.07 1.85v.132c-.299.105-.591.227-.875.364l-.093-.094c-.518-.519-1.139-.92-1.652-.92-.734 0-1.357 0-1.85.07-.515.072-1.016.224-1.463.671-.447.447-.6.948-.67 1.463-.07.493-.07 1.116-.07 1.85 0 .513.401 1.134.92 1.652l.094.093c-.137.284-.259.576-.364.875h-.132c-.734 0-1.357 0-1.85.07-.515.072-1.016.224-1.463.671-.447.447-.6.948-.67 1.463-.07.493-.07 1.116-.07 1.85s0 1.357.07 1.85c.072.515.224 1.016.671 1.463.447.447.948.6 1.463.67.493.07 1.116.07 1.85.07h.132c.105.299.227.591.364.875l-.094.093c-.519.518-.92 1.139-.92 1.652 0 .734 0 1.357.07 1.85.072.515.224 1.016.671 1.463.447.447.948.6 1.463.67.493.07 1.116.07 1.85.07.513 0 1.134-.401 1.652-.92l.093-.094c.284.137.576.259.875.364v.132c0 .734 0 1.357.07 1.85.072.515.224 1.016.671 1.463.447.447.948.6 1.463.67.493.07 1.116.07 1.85.07s1.357 0 1.85-.07c.515-.072 1.016-.224 1.463-.671.447-.447.6-.948.67-1.463.07-.493.07-1.116.07-1.85v-.132c.299-.105.591-.227.875-.364l.093.094c.518.519 1.139.92 1.652.92.734 0 1.357 0 1.85-.07.515-.072 1.016-.224 1.463-.671.447-.447.6-.948.67-1.463.07-.493.07-1.116.07-1.85 0-.513-.401-1.134-.92-1.652l-.094-.093c.137-.284.259-.576.364-.875h.132c.734 0 1.357 0 1.85-.07.515-.072 1.016-.224 1.463-.671.447-.447.6-.948.67-1.463.07-.493.07-1.116.07-1.85s0-1.357-.07-1.85c-.072-.515-.224-1.016-.671-1.463-.447-.447-.948-.6-1.463-.67-.493-.07-1.116-.07-1.85-.07h-.132a9.683 9.683 0 00-.364-.875l.094-.093c.519-.518.92-1.139.92-1.652 0-.734 0-1.357-.07-1.85-.072-.515-.224-1.016-.671-1.463-.447-.447-.948-.6-1.463-.67-.493-.07-1.116-.07-1.85-.07-.513 0-1.134.401-1.652.92l-.093.094a9.683 9.683 0 00-.875-.364v-.132c0-.734 0-1.357-.07-1.85-.072-.515-.224-1.016-.671-1.463-.447-.447-.948-.6-1.463-.67-.493-.07-1.116-.07-1.85-.07z"
        fill="currentColor"
      />
    </svg>
  );
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 1.25C6.063 1.25 1.25 6.063 1.25 12S6.063 22.75 12 22.75 22.75 17.937 22.75 12 17.937 1.25 12 1.25zM2.75 12a9.25 9.25 0 1118.5 0 9.25 9.25 0 01-18.5 0zM12 7.25a.75.75 0 01.75.75v8a.75.75 0 01-1.5 0V8a.75.75 0 01.75-.75zM12 4.75a.75.75 0 01.75.75v.01a.75.75 0 01-1.5 0V5.5a.75.75 0 01.75-.75z"
        fill="currentColor"
      />
    </svg>
  );
...
export function LogoutIcon(props: PropsType) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M16.617 2.25A1.25 1.25 0 0015.375 1H9c-1.38 0-2.5 1.12-2.5 2.5v.75a.75.75 0 001.5 0V3.5c0-.552.448-1 1-1h6.125a.25.25 0 01.25.25v18.5a.25.25 0 01-.25.25H9c-.552 0-1-.448-1-1v-.75a.75.75 0 00-1.5 0v.75c0 1.38 1.12 2.5 2.5 2.5h6.375a1.25 1.25 0 001.25-1.25V2.25z" />
      <path d="M10.22 6.22a.75.75 0 10-1.06 1.06L12.44 10.5H3.75a.75.75 0 000 1.5h8.69l-3.28 3.22a.75.75 0 101.06 1.06l4.5-4.5a.75.75 0 000-1.06l-4.5-4.5z" />
    </svg>
  );
}
